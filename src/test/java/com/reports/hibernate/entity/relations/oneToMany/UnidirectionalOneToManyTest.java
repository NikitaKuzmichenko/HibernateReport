...
import com.reports.hibernate.model.entity.relations.oneToMany.unidirectional.UnidirectionalOneToManyParent;
...
@EntityScan("com.reports.hibernate.model.entity.relations.oneToMany.unidirectional;") // scan only required entities
@DisplayName("Unidirectional OneToMany relationship")
